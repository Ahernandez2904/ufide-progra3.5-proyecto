<?php
	...
	if(isset($_POST['registrar'])) {
		...
		//Iniciar sesión
		if(empty($Registro)) {
			echo '<script>alert("Usuario no encontrado en el sistema");</script>';
		} else {
...
<html>
	...
	<body>
		...
		<div id="page">
			...
			<header id="gtco-header" class="gtco-cover gtco-cover-md" role="banner" style="background-image: url(images/gallery_02.jpg)" data-stellar-background-ratio="0.5">
				<div class="overlay"></div>
				<div class="gtco-container">
					<div class="row">
						<div class="col-md-12 col-md-offset-0 text-left">
							<div class="row row-mt-15em">
								<div class="col-md-7 mt-text animate-box fondone" data-animate-effect="fadeInUp">
									
									<h1 class="cursive-font"><img src="tickets-cr.png" width="80%" height="90%" ></h1>	
								</div>
				...
				<div class="gtco-container">
					<div class="row row-pb-md">
						...
						<div class="col-md-12 text-center copyright">
							<p>
								<small class="block">&copy;Proyecto creado por: Irene Salas, Alvaro Valverde y Alejandro Hernández.</small> 
								<small class="block">Proyecto para Universidad Fidelitas, carrera Ingeniería en Sistemas de Computación. <a href="https://ufidelitas.ac.cr/" target="_blank"> Ufidelitas</a></small>
							</p>
						</div>
					</div>
				</div>
